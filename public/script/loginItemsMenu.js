...
var items=$(".profile-div-product-box");
var itemsLength=items.length;
var cat_text;

for(var i=0;i<itemsLength;i++){

    var side1cat=$(".profile-div-category")[i].value;
    var side2cat=localStorage.category;

    var side1city=$(".profile-div-city")[i].value;
    ...
    if(side2cat=='na'){
       ...
       if(side1city!=side2city){
          $("#profile-div-product-box"+i).addClass("hide");
        }
